...
```{r}
project.bgcorrect.norm <- neqc(project, offset = 16) #function similar to dseq2 for rnaseq data
```
...
fit2 <- eBayes(fit2)
TopTable_Ex_diet <- topTable(fit2, adjust.method="BH", coef="ExDiet_end_vs_baseline", number=Inf) #BH = Benjamin-Halles correction for multiple testing
